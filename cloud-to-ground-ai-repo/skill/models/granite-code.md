...
These options live in `start_local_ai.sh` and are applied automatically
whenever the active model name begins with `granite`. Do **not** add
them to the prompt — the watcher handles it.
