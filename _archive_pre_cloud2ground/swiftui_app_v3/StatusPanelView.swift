        ...
        Form {
            ...
            Section {
                LabeledContent("Today") {
                    if let s = status.savings {
                        Text("\(s.todayTokens.formatted()) tokens · \(s.todayCount) tasks")
                            .monospaced()
                    } else {
                        Text("—").foregroundStyle(.secondary)
                    }
                ...
                LabeledContent("This week") {
                    if let s = status.savings {
                        Text("\(s.weekTokens.formatted()) tokens · \(s.weekCount) tasks")
                            .monospaced()
                    } else {
                        Text("—").foregroundStyle(.secondary)
                    }
                ...
                LabeledContent("All-time") {
                    if let s = status.savings {
                        Text("\(s.totalTokens.formatted()) tokens")
                            .monospaced()
                ...
                Text("Tokens generated on your Mac by the local model — work the cloud didn't have to do. Exact on-device counts; requires the telemetry watcher running.")
                    .font(.caption)
            }
